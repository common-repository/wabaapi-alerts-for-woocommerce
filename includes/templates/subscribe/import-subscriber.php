...
<div class="wrap color-333">
	<h2><?php esc_html_e('Import Subscibers', 'wabaapi_wa_alerts'); ?></h2>
	...
	<p><b>Step 1</b>: On the settings tab, Select Database table, Select our table <b>TABLE_PREFIX_wabaapi_wa_alerts_subscribers</b> from the dropdown.</p>
	...
	<figure class="wp-block-image"><img src="<?php echo esc_attr(WABAAPIWA_ALERTS_GATEWAY_URL); ?>/assets/images/csv_screenshot.png" alt="CSV Screenshot" class="wp-image-73" sizes="(max-width: 1024px) 100vw, 1024px"><figcaption>Fig. 1.1</figcaption></figure>
	...
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<p><strong>Important Note:</strong> Restrict to maximum 1000 Subscribers per group to send Coupon Announcements WhatsApp to listed Subscribers. Import Plugin does not validate mobile numbers, hence before uploading just uploaded the proper mobile numbers.</p>
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<p><strong>Tips:</strong></p>
	<p>When ever you want to send other than Coupons Announcement WhatsApp, just change the WhatsApp content from WABAAPI WhatsApp Alerts Settings page.</p>
</div>