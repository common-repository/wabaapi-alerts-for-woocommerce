		...
		<table class="form-table">
			<tbody>
				...
				<tr class="<?php echo esc_attr($template_name); ?>_mediaDiv" style="display:none">
					...
					<td>
						<input type="text" name="wabaapi_wa_alerts_option_name[<?php echo esc_attr($template_name); ?>_mediaUrl]" id="<?php echo esc_attr($template_name); ?>_mediaUrl" size="45" value="<?php
							if (isset($options[$template_name . '_mediaUrl'])) {
								echo trim(esc_attr($options[$template_name . '_mediaUrl']));
							}
						?>" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="wabaapi_wa_alerts_option_name[<?php echo esc_attr($template_name); ?>_tempName]" id="<?php echo esc_attr($template_name); ?>_tempName" size="45" value="<?php
						       if (isset($options[$template_name . '_tempName'])) {
							       echo trim(esc_attr($options[$template_name . '_tempName']));
						       }
						?>" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="wabaapi_wa_alerts_option_name[<?php echo esc_attr($template_name); ?>_header]" id="<?php echo esc_attr($template_name); ?>_header" size="45" value="<?php
						       if (isset($options[$template_name . '_header'])) {
							       echo trim(esc_attr($options[$template_name . '_header']));
						       }
						?>" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<div>
							<textarea name="wabaapi_wa_alerts_option_name[<?php echo esc_attr($template_name); ?>_tempMsg]" id="<?php echo esc_attr($template_name); ?>_tempMsg" rows="3" cols="50"><?php
						       if (isset($options[$template_name . '_tempName'])) {
							       echo trim(esc_attr($options[$template_name . '_tempMsg']));
						       }
						?></textarea>
						</div>
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" name="wabaapi_wa_alerts_option_name[<?php echo esc_attr($template_name); ?>_footer]" id="<?php echo esc_attr($template_name); ?>_footer" size="45" value="<?php
						       if (isset($options[$template_name . '_footer'])) {
							       echo trim(esc_attr($options[$template_name . '_footer']));
						       }
						?>" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<div>
							<textarea placeholder="<?php echo esc_attr('{ "button1": "Hello_button1", "button2": "Hello_button2", "button3": "Hello_button3" })'); ?>" name="wabaapi_wa_alerts_option_name[<?php echo esc_attr($template_name); ?>_btnPayload]" id="<?php echo esc_attr($template_name); ?>_btnPayload" rows="3" cols="50"><?php
								if (isset($options[$template_name . '_btnPayload'])) {
									echo trim(esc_attr($options[$template_name . '_btnPayload']));
								}
						?>
							</textarea>
						</div>
