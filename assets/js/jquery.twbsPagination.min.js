...
jQuery(document).ready(function($) {
    ...
    // Call the function for order complete
    toggleMediaDiv('wabaapi_alerts_order_complete_message_type', 'wabaapi_alerts_order_complete_mediaDiv');

    // Call the function for order processing
    toggleMediaDiv('wabaapi_alerts_order_processing_message_type', 'wabaapi_alerts_order_processing_mediaDiv');
    
     // Call the function for order processing
    toggleMediaDiv('wabaapi_alerts_order_cancelled_message_type', 'wabaapi_alerts_order_cancelled_mediaDiv');
    
     // Call the function for order processing
    toggleMediaDiv('wabaapi_alerts_order_failed_message_type', 'wabaapi_alerts_order_failed_mediaDiv');
    
     // Call the function for order processing
    toggleMediaDiv('wabaapi_alerts_order_onhold_message_type', 'wabaapi_alerts_order_onhold_mediaDiv');
    
     // Call the function for order processing
    toggleMediaDiv('wabaapi_alerts_order_pending_message_type', 'wabaapi_alerts_order_pending_mediaDiv');
    
     // Call the function for order processing
    toggleMediaDiv('wabaapi_alerts_order_refunded_message_type', 'wabaapi_alerts_order_refunded_mediaDiv');
